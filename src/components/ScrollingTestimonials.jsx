    ...
    <div className="bg-n-1/90 py-12">
      <div className="mb-8 px-4">
        ...
        <p className="text-center text-slate-950 text-sm mt-2 max-w-lg mx-auto">
          Education Millenials Experts yang sangat bertauliah dan patuh syariah.
        </p>
      </div>
      <div className="p-4 overflow-x-hidden relative">
        <div className="absolute top-0 bottom-0 left-0 w-24 z-10 bg-gradient-to-r from-slate-100 to-transparent" />
        ...
        <div className="absolute top-0 bottom-0 right-0 w-24 z-10 bg-gradient-to-l from-slate-100 to-transparent" />
      </div>
    </div>
  );
};
...
const testimonials = {
  top: [
    ...
    {
      id: 2,
      img: "https://vignette.wikia.nocookie.net/starwars/images/e/eb/ArtooTFA2-Fathead.png",
      name: "R2-D2,",
      title: "Founder of Perkim",
      info: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa nostrum labore dolor facilis.",
    },
    {
      id: 3,
      img: "https://vignette.wikia.nocookie.net/fr.starwars/images/3/32/Dark_Vador.jpg",
      name: "Darth Vader",
      title: "Founder of Jakim",
    ...
    },
    {
      ...
      title: "Founder of Halal Network",
      info: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa nostrum labore dolor.",
    },
    {
      id: 5,
      img: "https://vignette.wikia.nocookie.net/starwars/images/4/48/Chewbacca_TLJ.png",
      name: "Chewbacca",
      title: "Founder of Tabligh",
      info: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa nostrum labore.",
    },
    {
      id: 6,
      img: "https://vignette.wikia.nocookie.net/starwars/images/e/e2/TFAHanSolo.png",
      name: "Han Solo",
      title: "Founder of Illuminati",
